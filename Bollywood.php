...
<head>
    ...
    <style>
    header .Song_Section::before {
        
        background: url('PlaylistS Cover/12.png');
        width: 100%;
        height: 259px;
        margin-top: 42px;
...
<body>
    <header>
        ...
        <div class="Menu_Section">
            <a href="welcome.php"><h1> Your Playlist   </h1></a>
            <div class="Playlist">
        ...
        <div class="Song_Section">
            ...
            <div class="content">
                <h1> Bollywood Songs 2 </h1>
                <p>"Anime melodies, like a warm hug for the soul, bringing smiles with each note."

                    <br> "Lost in the rhythm of anime tunes, where every beat feels like a friend's familiar greeting."
                </p>
                <div class="buttons">
                    <button>Play</button>
            ...
            <div class="popular_artist">
                ...
                <div class="item art">
                    <li>
                        ...
                        <a href="onepiece.php"><img src="PlaylistS Cover/3.png" alt="1"></a>
                    </li>
                    <li>
                        <a href="ps.php"> <img src="PlaylistS Cover/4.jpg" alt="3"></a>
                    </li>
                    <li>
                        <a href="index.php"><img src="PlaylistS Cover/1.jpg" alt="4"></a>
                    </li>
