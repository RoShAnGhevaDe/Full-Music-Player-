...
const songs = [
    ...
    
    {
        ...
        poster : "Song Covers/17.jpg",
    },
    
    {
        id: 18,
        songName: `DDLJ <br><div class="subtitle"> DDLJ </div>`,
        poster : "Song Covers/18.jpg",
    },
    
    {
        id: 19, 
        songName: `हम कथा सुनाते राम सकल गुण धाम की <br><div class="subtitle">By luv Kush</div>`,
        poster : "Song Covers/19.jpg"
    },
    
    {
        id: 20, 
        songName: `Unravel <br><div class="subtitle">By TK from Ling Tosite Sigure</div>`,
        poster : "Song Covers/20.jpg",
    },
    {
        id: 21, 
        songName: `Mashle Op <br><div class="subtitle">By Masaru Yokoyama</div>`,
        poster : "Song Covers/21.jpg",
    }
]
...
Array.from(document.getElementsByClassName('playlistplay')).forEach((e)=>{
    ...
    e.addEventListener('click', (el) => {
        ...
        poster_play.src =`Song Covers/${index}.jpg`;
        music.play();
        masterplay.classList.remove('bi-play-fill');
        masterplay.classList.add('bi-pause-fill');
